   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">SUV Section</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">SUV Section</h1>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">SUV Add</h4>
                        <p class="m-0">Add SUV details</p>
                        <a href="{{url('/suvadd')}}" class="btn btn-primary">SUV Add</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">SUV View</h4>
                        <p class="m-0">View all SUV..</p>
                        <a href="{{url('/suvview')}}" class="btn btn-primary">SUV View</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">SUV Edit</h4>
                        <p class="m-0">Edit & Delete all SUV details</p>
                        <a href="{{url('/suveditview')}}" class="btn btn-primary">SUV Edit</a>
                    </div>
                </div>
            </div>
        </div>
