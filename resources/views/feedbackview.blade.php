...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Customer Feedback</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">ALL Feedback</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">ALL Customer feedback </h1>
            <div class="row">
    ...
    <table class="table table-responsiv table-hover">
        ...
        @foreach ($feed_back->all() as $allu )
        <tr>
            <td>{{$allu->Name}}</td>
            <td>{{$allu->Email}}</td>
            <td>{{$allu->Subject}}</td>
            <td>{{$allu->Feedback}}</td>
            <td><button class="bt btn-danger"><a href="{{url('/feedbackdelete')}}{{$allu->User_id}}">Delete</a></button>
           </td>
            <td>
</td>
        </tr>
