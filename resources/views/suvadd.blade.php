   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Add SUV</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Add SUV Details</h1>
            <div class="row">
                <div class="col-lg-12 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                    <div class="container-fluid py-5">
                        <form action="{{url('/suvaddaction')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="Name">Car Name:</label>
                                <input type="text" name="su_name" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="Name">Car Model:</label>
                                <input type="text" name="su_model" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="Name">Car Details:</label>
                                <input type="text" name="su_detail" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="Name">Car Rent:</label>
                                <input type="number" name="su_price" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="Image">Upload Image:</label>
                                <input type="file" name="su_avatar" required>
                            </div>
                            <center><button class="btn btn-lg btn-primary">ADD</button></center><br><br>
