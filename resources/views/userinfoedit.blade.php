    ...
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Edit Information</h1>
            <div class="row">
                <div class="col-lg-12 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                       @if (isset($User_edit))
                       @foreach ($User_edit->all() as $all )
                       <form action="{{url('/userinfoeditaction')}}" method="post" enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="avatar"><img src="{{$all->Photo}}" alt="" height="70" width="70">
                            </div>
                            <div class="form-group">
