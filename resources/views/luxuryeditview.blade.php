    ...
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Edit & Delete Luxury Details</h1>
            <div class="row">
                <div class="col-lg-12 mb-2">
                    ...
                    <div class="container-fluid py-5">
                        ...
                        <table class="table table-responsiv table-hover">
                            ...
                            @foreach ($l_ed->all() as $all)
                            <tr>
                                <td>{{$all->Name}}</td>
                                <td>{{$all->Details}}</td>
                                <td><img src="{{$all->Image}}" alt="" height="50px" width="50px"></td>
                                <td><button class="btn btn-sm btn-success"><a href="{{url('/luxuryeditform')}}{{$all->User_id}}" style="color:white;">Edit</a></button> <button class="btn btn-sm btn-danger"><a href="{{url('/luxurydelete')}}{{$all->User_id}}" style="color:white;">Delete</a></button></td>
                            </tr>
