...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">BOOK YOUR DRIVER</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">DRIVER VIEW</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">GET YOUR DRIVER</h1>
            @if (isset($DR_VIEW))
            <div class="row">
            @foreach ($DR_VIEW->all() as $all )
            
            <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item active mb-4">
                    <input type="hidden" value="{{$all->User_id}}" name="did">
                    <input type="hidden" value="{{$all->Name}}" name="d_name">
                    <input type="hidden" value="{{$all->Phone}}" name="d_phone">
                        <img class="img-fluid mb-4" src="banner/cover/driver.png" alt="">
                        <h4 class="text-uppercase mb-4">{{$all->Name}}</h4>
                        <b>Expericence: {{$all->Exp}} Yr</b><br>
                        <button class="btn btn-primary px-3"><a href="{{ url('/bookdriverView')}}{{ $all->Email}}" style="color:white;">&#8377;{{$all->Price}}/Day</a></button>
                    </div>
                </div>
