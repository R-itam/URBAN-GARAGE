   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Sedan Section</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Sedan Section</h1>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Sedan Add</h4>
                        <p class="m-0">Add sedan details</p>
                        <a href="{{url('/sedanadd')}}" class="btn btn-primary">Sedan Add</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Sedan View</h4>
                        <p class="m-0">View all sedan..</p>
                        <a href="{{url('/sedanview')}}" class="btn btn-primary">Sedan View</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Sedan Edit</h4>
                        <p class="m-0">Edit & Delete all sedan details</p>
                        <a href="{{url('/sedaneditview')}}" class="btn btn-primary">Sedan Edit</a>
