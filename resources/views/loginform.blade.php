...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Login Here</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Login Form</h6>
        </div>
    </div>
    <!-- Page Header Start -->
    @if (session('message'))
    ...
    @endif
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Login Here</h1>
            <div class="row">
                <div class="col-lg-12 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="{{url('/loginaction')}}" method="post" enctype="multipart/form-data">
                            ...
                            <center>Don't Have account ? <br><br><button class="btn btn-success"><a href="{{url('/registrationform')}}"style="color:white;">Sign-Up</a></button></center>
                        </form>
