   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Booking Details</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Booking Details</h1>
            <!-- <div class="row" > -->
            ...
            <!-- <div class="row" > -->
                    ...
                    <div class="contact-form bg-light mb-4" style="padding: 30px;" width="700px">
                      ...
                      <table border="1px" class="table-responsiv table-hover"  align="center" >
                        ...
                        <tr>
                            ...
                            <td>{{$all->Status}}</td>
                            <td>@if ($all->Auth==0 ||$all->Auth==2)
                                <button class="bt btn-sm btn-danger"><a href="{{url('/ucanceldrive')}}{{$all->User_id}}">Cancel</a></button>
                            @else
                            <b>{{$all->Status}}</b>
                            @endif </td>
                        </tr>
                ...
                <center><a href="{{url('/userhome')}}">Back >></a></center>
