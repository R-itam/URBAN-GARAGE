     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <!-- <div class="row" > -->
                    ...
                    <!-- <div class="contact-form bg-light mb-4" style="padding: 30px;" width="700px">
                    
                      @if (isset($BData))
                      <table border="1px" class="table-responsiv table-hover"  align="center" >
                        <tr>
                            <th>NAME</th>
                            <th>EMAIL</th>
                            <th>PHONE</th>
                        ...
                        <tr>
                            ...
                            <td>{{$all->Pick_up_date}}</td>
                            <td><img src="{{$all->Document}}" alt="" height="70px" width="70px"></td>
                            <td>{{$all->Address}}</td>
                            <td>{{$all->Num_of_day}}</td>
                            <td>{{$all->Payment}}</td>
                            <td>{{$all->Status}}</td>
                            <td>@if ($all->Auth==0 ||$all->Auth==2)
                                <button class="bt btn-sm btn-danger"><a href="{{url('/ucanceltrip')}}{{$all->User_id}}">Cancel</a></button>
                            @else
                            <b>{{$all->Status}}</b>
                            @endif </td>
                        </tr>
            ...
            <!-- <div class="row" > -->
                    ...
                    <div class="contact-form bg-light mb-4" style="padding: 30px;" width="700px">
                      ...
                      <table border="1px" class="table-responsiv table-hover"  align="center" >
                        ...
                        <tr>
                            ...
                            <td>{{$all->Status}}</td>
                            <td>@if ($all->Auth==0)
                            <button class="bt btn-sm btn-success"><a href="{{url('driverconfirmtr')}}{{$all->User_id}}">Confirm</a></button>  <button class="bt btn-sm btn-danger"><a href="{{url('/dranceldrive')}}{{$all->User_id}}">Cancel</a></button>
                            @elseif($all->Auth==2||$all->Auth==5)
                            <button class="bt btn-sm btn-danger"><a href="{{url('/dranceldrive')}}{{$all->User_id}}">Cancel</a></button>
                            @else
                            <b>{{$all->Status}}</b>
                            @endif </td>
                        </tr>
                ...
                <center><a href="{{url('/driverhome')}}">Back >></a></center>
