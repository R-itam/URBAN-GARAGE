...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Driver Section</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Driver Section</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Driver Section</h1>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Driver List</h4>
                        <p class="m-0">See All Driver List</p>
                        <a href="{{url('/driverlist')}}" class="btn btn-primary">Driver List</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Driver View</h4>
                        <p class="m-0">View all driver..</p>
                        <a href="{{url('/driverview')}}" class="btn btn-primary">Driver View</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Driver Edit</h4>
                        <p class="m-0">Delete  Driver details</p>
                        <a href="{{url('/drivereditview')}}" class="btn btn-primary">Driver Edit</a>
                    </div>
                </div>
