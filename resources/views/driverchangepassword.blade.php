            ...
            <div class="row">
                <div class="col-lg-12 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="{{url('/drchangepasswordaction')}}" method="post" >
                            @csrf
                            ...
                            <center><button type="submit" class="btn btn-primary ">Change Password</button></center><br><br>
                            <center><button class="btn btn-success"><a href="{{url('/driverinfo')}}"style="color:white;">Back >></a></button></center>
                        </form>
                    </div>
                </div>
            </div>
