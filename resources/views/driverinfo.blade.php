...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Driver Information</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Your Info</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Your Information</h1>
            <div class="row">
                <!--  -->
                    <div class="contact-form bg-light mb-4" style="padding: 30px;margin-left:40px;">
                    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            @if (isset($Dinfo))
            <table class="table table-striped table-dark table-hover">
                ...
                @foreach ($Dinfo->all() as $all )
                <td>{{$all->Name}}</td>
                <td>{{$all->Email}}</td>
                <td>{{$all->Phone}}</td>
                <td>{{$all->Gender}}</td>
                <td>{{$all->Address}}</td>
                <td><img src="{{$all->Image}}" alt="" height="60px" width="70px"></td>
                <td>{{$all->Price}}/day</td>
                <td><button class="btn btn-sm btn-primary"><a href="{{url('/driverinfoedit')}}">Edit</a></button><button class="btn btn-sm btn-warning"><a href="{{url('/driverchangepassword')}}">Change Password</a></button></td>
