   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase m-0"><a class="text-white" href="{{url('/driverhome')}}">Home</a></h6>
                        ...
                        <form action="{{url('/drfeedbackaction')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-6 form-group">
                                    <input type="text" class="form-control p-4" name="drname" placeholder="Your Name" required="required">
                                </div>
                                <div class="col-6 form-group">
                                    <input type="email" class="form-control p-4" name="dremail" placeholder="Your Email" required="required">
                                </div>
                            </div>
