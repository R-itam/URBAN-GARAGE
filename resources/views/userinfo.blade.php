...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Your Information</h1>
     ...
     <div class="container-fluid py-5">
        ...
        <div class="container pt-5 pb-3">
            ...
            <table class="table table-striped table-dark table-hover">
                ...
                @foreach ($U_info->all() as $all )
                <td>{{$all->Name}}</td>
                <td>{{$all->Email}}</td>
                <td>{{$all->Phone}}</td>
                <td>{{$all->Gender}}</td>
                <td>{{$all->Address}}</td>
                <td><img src="{{$all->Photo}}" alt="" height="60px" width="70px"></td>
                <td>{{$all->Password}}</td>
                <td><button class="btn btn-sm btn-primary"><a href="{{url('/userinfoedit')}}">Edit</a></button><button class="btn btn-sm btn-warning"><a href="{{url('/changepassword')}}">Change Password</a></button></td>
                
                @endforeach
            </table> 
            @if ($all->User_type=='Admin')
            <center><a href="{{url('/adminhome')}}">Back >></a></center>
            @else
