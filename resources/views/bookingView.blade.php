...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Book Car</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Book Car</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Book Car</h1>
            <div class="row">
                <div class="col-lg-12 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                       @if (isset($car_id))
                       <form action="{{url('/bookingaction')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="car_name">Car Name:</label>
                                <input type="text" value="{{$car_id}}" class="form-control p-4" name="car_name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="address" class="form-control px-3" placeholder="enter your address" rows="5"></textarea>
                            </div>
                            <div class="form-group">
