    ...
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Edit & Delete Sedan Details</h1>
            <div class="row">
                <div class="col-lg-12 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                    <div class="container-fluid py-5">
                        @if (isset($s_ed))
                        <table class="table table-responsiv table-hover">
                            <tr>
                                <th>Name</th>
                                <th>Details</th>
                                <th>Image</th>
                            ...
                            @foreach ($s_ed->all() as $all)
                            <tr>
                                <td>{{$all->Name}}</td>
                                <td>{{$all->Details}}</td>
                                <td><img src="{{$all->Image}}" alt="" height="50px" width="50px"></td>
                                <td><button class="btn btn-sm btn-success"><a href="{{url('/sedaneditform')}}{{$all->User_id}}" style="color:white;">Edit</a></button> <button class="btn btn-sm btn-danger"><a href="{{url('/sedandelete')}}{{$all->User_id}}" style="color:white;">Delete</a></button></td>
                            </tr>
