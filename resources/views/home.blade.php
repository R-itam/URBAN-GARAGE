            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="{{url('/about')}}" class="nav-item nav-link disabled">About</a>
                        <a href="{{url('/servies')}}" class="nav-item nav-link disabled">Service</a>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle disabled" data-toggle="dropdown">Cars</a>
                        ...
                        <button class="bt  btn-primary"><a href="{{url('/showpage')}}">Login/Sign-Up</a></button>
                        <!-- <button class="btn  btn-warning"><a href="{{url('/diverlogin')}}">For Driver</a></button> -->
                    </div>
                </div>
            </nav>
        </div>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Rent A Driver</h4>
                            <h1 class="display-1 text-white mb-md-4">Quality Driver with Best Price</h1>
        ...
        <div class="container py-5">
            <div class="bg-banner py-5 px-4 text-center">
                <div class="py-5">
                    ...
                    <a class="btn btn-primary mt-2 py-3 px-5" href="{{url('/showpage')}}">Register Now</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-7 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form>
                            ...
                            <div>
                                <button class="btn btn-primary py-3 px-5" type="submit" id="bt" >Send Message</button>
                            </div>
                        </form>
                    </div>
                </div>
