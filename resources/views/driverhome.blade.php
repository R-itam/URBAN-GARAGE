        ...
        <div class="position-relative px-lg-5" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    ...
                    <a href="{{url('/driverinfo')}}" class="nav-item nav-link">Info</a>
                        <a href="{{url('/driverhome')}}" class="nav-item nav-link active">Home</a>
                       
                        <a href="{{url('/drivercontact')}}" class="nav-item nav-link">Contact</a>
                        <a href="{{url('/driverbookingdetail')}}" class="nav-item nav-link">Booking</a>
        ...
        <div id="header-carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Be A Driver</h4>
                            <h1 class="display-1 text-white mb-md-4">Best Place To Be A Driver</h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">On Time Payment</h4>
                            <h1 class="display-1 text-white mb-md-4">Get Quality Money From Here </h1>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h4 class="text-white text-uppercase mb-md-3">Everyday Work </h4>
                            <h1 class="display-1 text-white mb-md-4">You Get Everyday Work From Here </h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Get Driver</h4>
                        <p class="m-0">Book a driver for your car ....</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-7 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="{{url('/drfeedbackaction')}}" method="post">
                            @csrf
                            <div class="row">
