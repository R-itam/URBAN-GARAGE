                    ...
                    <div class="contact-form bg-light mb-4" style="padding: 20px;">
                      ...
                      <table class="table table-striped table-dark table-hover">
                       ...
                       <tr >
                        ...
                        <td>@if ($all->Auth==3)
                            <b>User Cancel</b>
                            @else <button class="bt btn-sm btn-danger"><a href="{{'/canceltrip'}}{{$all->User_id}}">Cancel</a></button> <button class="bt btn-sm btn-success"><a href="{{'/confirmtrip'}}{{$all->User_id}}">Confirm</a></button>
