   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Luxury Section</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Luxury Section</h1>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Luxury Add</h4>
                        <p class="m-0">Add Luxury details</p>
                        <a href="{{url('/luxuryadd')}}" class="btn btn-primary">Luxury Add</a>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Luxury View</h4>
                        <p class="m-0">View all Luxury..</p>
                        <a href="{{url('/luxuryview')}}" class="btn btn-primary">Luxury View</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-2">
                    <div class="service-item d-flex flex-column justify-content-center px-4 mb-4">
                        ...
                        <h4 class="text-uppercase mb-3">Luxury Edit</h4>
                        <p class="m-0">Edit & Delete all Luxury details</p>
                        <a href="{{url('/luxuryeditview')}}" class="btn btn-primary">Luxury Edit</a>
                    </div>
                </div>
