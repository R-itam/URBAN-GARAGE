...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Register User</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Register User</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">ALL Register User Details</h1>
            <div class="row">
    ...
    <table class="table table-responsiv table-hover">
        ...
        <tr>
            ...
            <td>{{$allu->Gender}}</td>
            <td>{{$allu->Address}}</td>
            <td><img src="{{$allu->Photo}}" alt="" height="50px" width="50px"></td>
            <td><button class="bt btn-danger"><a href="{{url('/block')}}{{$allu->User_id}}">Block</a></button><button class="bt btn-success"><a href="{{url('/unblock')}}{{$allu->User_id}}">Unblock</a></button>
           </td>
            <td>
    @if($allu->Auth == 1)
        <b>Block</b>
