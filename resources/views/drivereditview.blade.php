   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        ...
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Edit Driver</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Edit & Delete Driver Details</h1>
            <div class="row">
                    ...
                    <div class="container-fluid py-5">
                        ...
                        <table class="table table-responsiv table-hover">
                            ...
                            <tr>
                                ...
                                <td><button class="btn btn-sm btn-danger"><a href="{{url('/driverdelete')}}{{$all->User_id}}" style="color:white;">Delete</a></button></td>
                            </tr>
                        ...
                        @endif
                        <center><a href="{{url('/driversection')}}">Back >></a></center>
