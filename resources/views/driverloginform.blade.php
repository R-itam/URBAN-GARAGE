...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Driver Login Here</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Driver Login Form</h6>
        </div>
    </div>
    <!-- Page Header Start -->
    @if (session('message'))
    ...
    @endif
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Driver Login Here</h1>
            <div class="row">
                <div class="col-lg-12 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                        <form action="{{url('/driverloginaction')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="Username">User Name:</label>
                                <input type="text" name="username" placeholder="enter your email or phone" class="form-control p-4">
                            </div>
                            <div class="form-group">
                                <label for="Password">Password:</label>
                                <input type="password" name="password" placeholder="enter your password" class="form-control">
                            </div>
                            <center><button type="submit" class="btn btn-primary ">Log-In</button></center><br><br>
                            <center>Don't Have account ? <br><br><button class="btn btn-success"><a href="{{url('/driverregistrationform')}}"style="color:white;">Sign-Up</a></button></center>
                        </form>
                        
                    </div>
                    <center><a href="{{url('/showpage')}}">< < < < </a></center>
                </div>
            </div>
        </div>
    </div>
