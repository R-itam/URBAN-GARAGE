...
<body>
   ...
   <br><br>
    ...
    <div class="container-fluid page-header">
        <h1 class="display-3 text-uppercase text-white mb-3">Book Driver</h1>
        <div class="d-inline-flex text-white">
            <h6 class="text-uppercase text-body m-0">Book Driver</h6>
        </div>
    </div>
    <!-- Page Header Start -->
     ...
     <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            ...
            <h1 class="display-4 text-uppercase text-center mb-5">Book Driver</h1>
            <div class="row">
                <div class="col-lg-12 mb-2">
                    <div class="contact-form bg-light mb-4" style="padding: 30px;">
                       @if (isset($dr_INFO))
                       @foreach ($dr_INFO->all() as $all )
                       <form action="{{url('/bookingdriveraction')}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <h3 align="center">Driver Details</h3>
                            <div class="form-group">
                                <label for="d_name">Driver Name:</label>
                                <input type="text"  class="form-control p-4" name="d_name" value="{{$all->Name}}" readonly >
                            </div>
                            <div class="form-group">
                                <label for="d_email">Driver Email:</label>
                                <input type="email"  class="form-control p-4" name="d_email" value="{{$all->Email}}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="d_phone">Driver Phone:</label>
                                <input type="number"  class="form-control p-4" name="d_phone" value="{{$all->Phone}}" readonly >
                            </div><hr>
                            <h3 align="center">Your Details</h3>
                            <div class="form-group">
                                <label for="Pick-Up Location">Pick-Up Location:</label>
                                <input type="text" name="pic_loc" placeholder="enter pick-up location" class="form-control p-4">
                            </div>
                            <div class="form-group">
                                <label for="Destination">Destination:</label>
                                <input type="text" name="desti" placeholder="enter destination " class="form-control p-4">
                            </div>
                            <div class="form-group">
                                <label for="Pick-Up Date">Pick-Up Date:</label>
                                <input type="date" name="pick_date"  class="form-control p-4">
                            </div>
                            <div class="form-group">
                                <label for="Upload Document">Upload Document:</label>
                                <input type="file" name="document"> <span>your aadhaar-card/voter-card</span>
                            </div>
                            
                            <div class="form-group">
                                <label for="Number of Day">Number of Day:</label>
                                <input type="number" name="nod" placeholder="enter no day  max:10days" class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <input type="checkbox" id="checkbox_id" name="terms" required> <a href="{{url('/termscondition')}}">Terms & Condition</a>
                            <center><button type="submit" class="btn btn-primary py-3 px-5">Book</button></center>
                        </form>
